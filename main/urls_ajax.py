...
urlpatterns = [
    ...
    path('a/layer/setname',      tools.layers.set_name,         name='ajax_layer_setname'),
    path('a/layer/setparent',    tools.layers.set_parent,       name='ajax_layer_setparent'),
    path('a/layer/removeparent', tools.layers.unset_parent,     name='ajax_layer_unsetparent'),
